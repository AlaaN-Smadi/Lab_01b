...
if (color == "White") {
    ...
    document.writeln(`<h3 style="background:white;"> Your Age  ${age} </h3>`)
} else if (color == "Red") {
    document.writeln(`<h3 style="background:red;"> Welcome mr  ${userName} </h3>`)
    
    document.writeln(`<h3 style="background:red;"> Your Age  ${age} </h3>`)

} else {
    document.writeln(`<h3 style="background:yellow;"> Welcome mr  ${userName} </h3>`)
    
    document.writeln(`<h3 style="background:yellow;"> Your Age  ${age} </h3>`)
